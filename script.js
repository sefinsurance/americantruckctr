...
const data={
  repair:{badge:{en:'Mechanical Repair',es:'Reparación Mecánica'},title:{en:'Heavy-duty and light-duty truck repair.',es:'Reparación de camiones pesados y ligeros.'},text:{en:'Our certified mechanics diagnose and repair engines, transmissions, brakes, suspension, electrical, and A/C on trucks of every size.',es:'Nuestros mecánicos certificados diagnostican y reparan motores, transmisiones, frenos, suspensión, sistema eléctrico y aire acondicionado en camiones de todo tamaño.'},bullets:{en:['Engine, transmission, brake and suspension repair','Computerized diagnostics and check-engine work','Preventive maintenance, DOT inspections, tires and alignment'],es:['Reparación de motor, transmisión, frenos y suspensión','Diagnóstico computarizado y trabajo de check-engine','Mantenimiento preventivo, inspecciones DOT, llantas y alineación']},image:'assets/interior-blue-bay.png?v=9',alt:{en:'Certified mechanic servicing a blue semi truck inside a repair bay',es:'Mecánico certificado dando servicio a un camión azul en una bahía de reparación'}},
  ...
  towing:{badge:{en:'Towing & Roadside',es:'Grúa y Asistencia'},title:{en:'Towing and roadside assistance when you need it.',es:'Grúa y asistencia en carretera cuando la necesita.'},text:{en:'Stuck on the side of the road? We offer towing service and roadside assistance to get your down truck into our shop and back to work.',es:'¿Varado a un lado de la carretera? Ofrecemos servicio de grúa y asistencia en carretera para llevar su camión averiado a nuestro taller y de vuelta al trabajo.'},bullets:{en:['Towing service for heavy-duty and light-duty trucks','Roadside assistance to get you off the shoulder','Direct line to the shop for fast repairs once you arrive'],es:['Servicio de grúa para camiones pesados y ligeros','Asistencia en carretera para sacarlo del arcén','Línea directa con el taller para reparaciones rápidas al llegar']},image:'assets/freight-loading.png?v=9',alt:{en:'Commercial truck being loaded and serviced',es:'Camión comercial siendo cargado y atendido'}}
};
